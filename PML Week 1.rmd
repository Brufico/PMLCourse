---
title: "Practical Machine Learning Course, Week 1"
author: "Jeff Leaks, notes by Bruno Fischer Colonimos"
...
```{r setupchunk, include=FALSE, cache = F, echo = F, message = F, warning = F, tidy = F}
if(!require(knitr)) {
