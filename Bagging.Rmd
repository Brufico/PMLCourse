...
```{r, dependson="baggedOzone", warning=FALSE, fig.align = "center", fig.width = 5, fig.asp = 0.75}
...
# final touch
g <- g + labs(title = "bagged loess (red)", 
...
```{r,dependson="bag1", fig.align = "center", fig.width = 5, fig.asp = 0.75}
